...
val excipients = listOf(
    ...
    Excipient("Bentonite", "bentonite", "Thickener, Adsorbent", "Inorganic molecule", "Veegum, hydrated aluminium silicate",
    ...
    Excipient("Boric acid", "boricacid", "Tonicity regulator, Buffer", "Inorganic molecule",
    ...
    Excipient("Colloidal silicon dioxide", "sio2", "Lubricant, Glidant, Thickener, Adsorbent", "Inorganic molecule",
    ...
    Excipient("Disodium hydrogen phosphate", "disodiumhydrogenphosphate", "Peptizing agent, Buffer", "Inorganic molecule",
        "", "Suspensions", "Neutral under very acid conditions (pKas of 2.15, 7.21, and 12.32)", "Water soluble", "Peptizing agents help with making a partially flocculated suspension by diminishing the zeta potential of the suspended particles. Deflocculated suspensions are much more stable. Particles with multiple charges are better at achieving this, which explains the common peptizing agents. Concentration: 0.001-0.1M."),
    Excipient("Ethanol", "ethanol", "Solvent, Preservative, Cosolvent, Dispersing agent", "Small organic molecule", "Alcohol",
    ...
    Excipient("Glycerol monostearate", "glycerolmonostearate", "Emulsifier (W/O), Modified release agent, Lubricant", "Small organic molecule", "Glycerin monostearate, monostearin, GMS",
    ...
    Excipient("Hydroxyethyl cellulose", "hydroxyethylcellulose", "Thickener, Modified release agent, Binder", "Polymer",
    ...
    Excipient("Hydroxypropyl cellulose", "hydroxypropylcellulose", "Modified release agent, Binder, Thickener", "Polymer",
    ...
    Excipient("Hydroxypropyl methylcellulose", "hydroxypropylmethylcellulose", "Binder, Modified release agent, Thickener, Emulsifier (O/W)", "Polymer",
    ...
    //TODO add poloxamers
    Excipient("Polyethylene glycol", "peg", "Modified release agent, Plasticizer, Solvent, Base for creams/ointments, Base for suppositories, Lubricant", "Polymer",
    ...
    Excipient("Potassium citrate", "potassiumcitrate", "Peptizing agent, Buffer", "Small organic molecule",
    ...
    Excipient("Sodium citrate", "sodiumcitrate", "Peptizing agent, Buffer", "Small organic molecule",
    ...
    Excipient("Talc", "talc", "Lubricant, Glidant, Filler", "Inorganic molecule",
