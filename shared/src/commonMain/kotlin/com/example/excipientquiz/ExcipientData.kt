...
val excipients = listOf(
    ...
    Excipient("Arabic gum", "arabicgum", "Emulsifier (O/W), Thickener", "Polymer",
    ...
    Excipient("Bentonite", "bentonite", "Adsorbent, Thickener", "Inorganic molecule", "Veegum, hydrated aluminium silicate",
    ...
    Excipient("Boric acid", "boricacid", "Buffer, Tonicity regulator", "Inorganic molecule",
    ...
    Excipient("Polyoxyethylene Alkyl Ethers", "brij", "Emulsifier (generally O/W)", "Small organic molecule",
    ...
    Excipient("Calcium stearate", "castearate", "Emulsifier (W/O), Glidant, Lubricant", "Small organic molecule",
    ...
    Excipient("Cellulose acetophtalate", "cap", "Modified release agent", "Polymer",
    ...
    Excipient("Cetostearyl alcohol", "cetostearylalcohol", "Emulsifier (W/O), Modified release agent", "Small organic molecule",
    ...
    Excipient("Cetrimide", "cetrimide", "Emulsifier (O/W), Preservative, Solubilizer", "Small organic molecule",
    ...
    Excipient("Cetyl alcohol", "cetylalcohol", "Emulsifier (W/O), Modified release agent", "Small organic molecule", "none",
    ...
    Excipient("Chlorhexidine", "chlorhexidine", "Desinfectant, Preservative", "Small organic molecule", "none",
    ...
    Excipient("Comperlan", "comperlan", "Emulsifier (W/O), Foam stabiliser", "Small organic molecule", "Cocamide diethanolamine, cocamide monoethanolamine, cocamide triethanolamine",
    ...
    Excipient("Cresol", "cresol", "Desinfectant, Preservative", "Small organic molecule",
    ...
    Excipient("Colloidal silicon dioxide", "sio2", "Adsorbent, Glidant, Lubricant, Thickener", "Inorganic molecule",
    ...
    Excipient("Cremophor EL", "cremophor", "Emulsifier (O/W), Solubilizer", "Small organic molecule", "Kolliphor EL, polyethoxylated castor oil",
    ...
    Excipient("Dibutyl sebacate", "dbs", "Plasticizer", "Small organic molecule",
        "DBS", "Solid dosage forms", "Neutral", "Water insoluble (0.04 g/L)", "none"),
    ...
    Excipient("Disodium hydrogen phosphate", "disodiumhydrogenphosphate", "Buffer, Peptizing agent", "Inorganic molecule",
        "", "Suspensions", "Neutral under very acid conditions (pKas of 2.15, 7.21, and 12.32)", "Water soluble", "Peptizing agents help with making a partially flocculated suspension by diminishing the zeta potential of the suspended particles. Deflocculated suspensions are much more stable. Particles with multiple charges are better at achieving this, which explains the common peptizing agents. Concentration: 0.001-0.1M."),
    Excipient("Ethanol", "ethanol", "Cosolvent, Dispersing agent, Preservative, Solvent", "Small organic molecule", "Alcohol",
    ...
    Excipient("Ethyl cellulose", "ethylcellulose", "Modified release agent", "Polymer",
    ...
    Excipient("Eudragit L100", "eudragitl100", "Modified release agent", "Polymer",
    ...
    Excipient("Eudragit RL/RS", "eudragitrlrs", "Modified release agent", "Polymer",
        "Copolymer of methacrylic acid and methacrylic acid esters", "Solid dosage forms", "Positive", "none", "none"),
    Excipient("Gelatin", "gelatin", "Base for suppositories, Binder, Capsule manufacture", "Polymer",
    ...
    Excipient("Glycerol", "glycerol", "Dispersing agent, Plasticizer, Preservative, Solvent, Sweetener, Thickener", "Small organic molecule",
    ...
    Excipient("Glycerol monostearate", "glycerolmonostearate", "Emulsifier (W/O), Lubricant, Modified release agent", "Small organic molecule", "Glycerin monostearate, monostearin, GMS",
    ...
    Excipient("Hydroxyethyl cellulose", "hydroxyethylcellulose", "Binder, Modified release agent, Thickener", "Polymer",
    ...
    Excipient("Hydroxypropyl cellulose", "hydroxypropylcellulose", "Binder, Modified release agent, Thickener", "Polymer",
    ...
    Excipient("Hydroxypropyl methylcellulose", "hydroxypropylmethylcellulose", "Binder, Emulsifier (O/W), Modified release agent, Thickener", "Polymer",
    ...
    Excipient("Hydroxypropyl methylcellulose acetate succinate", "hpmcas", "Modified release agent", "Polymer",
    ...
    Excipient("Hydroxypropyl methylcellulose phtalate", "hpmcp", "Modified release agent", "Polymer",
    ...
    Excipient("Lactose", "lactose", "Filler", "Small organic molecule",
    ...
    Excipient("Lanolin", "lanolin", "Base for creams/ointments, Emulsifier (W/O)", "Small organic molecule", "Wool fat, Sheep fat, Adeps lanae, Wool grease",
    ...
    Excipient("Magnesium Stearate", "magnesiumstearate", "Emulsifier (W/O), Lubricant", "Small organic molecule",
    ...
    Excipient("Mannitol", "mannitol", "Filler, Plasticizer, Sweetener, Tonicity regulator", "Small organic molecule",
    ...
    Excipient("Menthol", "menthol", "Counterirritant, Sensory modifier", "Small organic molecule",
        "none", "Creams/ointments", "Neutral", "none", "none"),
    Excipient("Methyl cellulose", "methylcellulose", "Binder, Disintegrant, Thickener", "Polymer",
    ...
    Excipient("Microcrystalline Cellulose", "cellulose", "Adsorbent, Binder, Disintegrant, Filler, Thickener", "Polymer",
    ...
    Excipient("Paraffin", "paraffin", "Base for creams/ointments", "Small organic molecule", "Vaseline, Petroleum jelly, paraffin wax, mineral oil, paraffin oil, petroleum wax",
    ...
    Excipient("Crosslinked poly acrylic acid", "polyacrylicacid", "Binder, Thickener", "Polymer",
    ...
    Excipient("Peanut oil", "peanutoil", "Base for creams/ointments", "Small organic molecule",
    ...
    Excipient("Propylene glycol", "propyleneglycol", "Dispersing agent, Preservative, Solvent", "Small organic molecule",
    ...
    //TODO add poloxamers
    Excipient("Polyethylene glycol", "peg", "Base for creams/ointments, Base for suppositories, Lubricant, Modified release agent, Plasticizer, Solvent", "Polymer",
    ...
    Excipient("Polyvinyl alcohol", "polyvinylalcohol", "Binder, Non-functional tablet coating, Thickener", "Polymer",
        "PVA", "Solid dosage forms", "Neutral", "Water soluble.", "PVA can also used as a stabiliser for emulsions."),
    Excipient("Polyvinylpyrrolidone", "pvp", "Binder, Modified release agent", "Polymer",
    ...
    Excipient("Polyvinylpyrrolidone-co-vinyl acetate", "pvpva", "Binder, Modified release agent", "Polymer",
    ...
    Excipient("Potassium citrate", "potassiumcitrate", "Buffer, Peptizing agent", "Small organic molecule",
    ...
    Excipient("Potassium nitrate", "potassiumnitrate", "Tonicity regulator", "Inorganic molecule",
    ...
    Excipient("Potassium tartrate", "potassiumtartrate", "Peptizing agent", "Small organic molecule",
    ...
    Excipient("Sodium alginate", "sodiumalginate", "Binder, Emulsifier (O/W), Disintegrant, Thickener", "Polymer",
    ...
    Excipient("(cross-linked) Sodium carboxymethyl cellulose", "sodiumcarboxymethylcellulose", "Disintegrant, Thickener", "Polymer",
    ...
    Excipient("Sodium citrate", "sodiumcitrate", "Buffer, Peptizing agent", "Small organic molecule",
    ...
    Excipient("Starch", "starch", "Binder, Disintegrant, Filler, Thickener", "Polymer",
    ...
    Excipient("Stearic acid", "stearicacid", "Emulsifier (W/O), Glidant, Lubricant, Solubilizer", "Small organic molecule",
    ...
    Excipient("Talc", "talc", "Glidant, Lubricant, Filler", "Inorganic molecule",
    ...
    Excipient("Tragacanth", "tragacanth", "Emulsifier (O/W), Thickener", "Polymer",
    ...
    Excipient("Triethanol amine stearate", "triethanolaminestearate", "Emulsifier (O/W)", "Small organic molecule",
    ...
    Excipient("Waxes", "wax", "Base for creams/ointments, Emulsifier (W/O), Modified release agent", "Small organic molecule",
...
private fun createGroupedMap(excipients: List<Excipient>, keySelector: (Excipient) -> String, allItemsName: String): Map<String, List<Excipient>> {
    // This is the ENCYCLOPEDIA logic. It is robust and handles all your requirements.
    val functionNormalizationMap = mapOf(
        "Emulsifier (generally O/W)" to "Emulsifier (O/W)"
    )

    val getNormalizedFunctions: (Excipient) -> List<String> = { excipient ->
        keySelector(excipient).split(',').map { it.trim() }.map { function ->
            functionNormalizationMap[function] ?: function        }
    }

    val allNormalizedFunctions = excipients.flatMap(getNormalizedFunctions).filter { it.isNotEmpty() }
    val functionCounts = allNormalizedFunctions.groupingBy { it }.eachCount()

    val mainCategories = functionCounts
        .filter { (function, count) -> count > 1 && function != "Verify emulsion type" }
        .keys

    val otherCategories = functionCounts
        .filter { (function, count) -> count == 1 || function == "Verify emulsion type" }
        .keys
    ...
    mainCategories.sorted().forEach { category ->
        finalMap[category] = excipients.filter { getNormalizedFunctions(it).contains(category) }.sortedBy { it.name }
    }

    val otherExcipients = excipients.filter { excipient ->
        getNormalizedFunctions(excipient).any { it in otherCategories }
    }

    if (otherExcipients.isNotEmpty()) {
        finalMap["Other"] = otherExcipients.distinct().sortedBy { it.name }
    }
...
private fun createGroupedQuizModes(excipients: List<Excipient>, allItemsName: String): Map<String, List<Excipient>> {
    // This is the QUIZ logic. It is now corrected to work with your new data file.
    val finalMap = mutableMapOf<String, List<Excipient>>()
    finalMap[allItemsName] = excipients
    ...
    val usageToGroupMap = mapOf(
        ...
        "Solid dosage forms" to "Solid dosage forms",
        "Suppositories" to "Other",
        "Lotions & shampoos" to "Other"
    )

    val getUsageGroups: (Excipient) -> Set<String> = { excipient ->
        excipient.usage.split(',').mapNotNull { usage ->
            usageToGroupMap[usage.trim()]
        }.toSet()
    }

    val allRemainingGroups = remainingExcipients.flatMap(getUsageGroups).toSet()

    allRemainingGroups.forEach { groupName ->
        if (groupName != "Other") {
            finalMap[groupName] = remainingExcipients.filter { getUsageGroups(it).contains(groupName) }.distinct().sortedBy { it.name }
        }
    }

    val explicitlyOther = remainingExcipients.filter { excipient ->
        val groups = getUsageGroups(excipient)
        groups.contains("Other") || groups.isEmpty() || groups.all { group -> finalMap[group]?.size == 1 }
    }.distinct().sortedBy { it.name }

    if (explicitlyOther.isNotEmpty()) {
        finalMap["Other"] = (finalMap["Other"] ?: emptyList()) + explicitlyOther
        finalMap["Other"] = finalMap["Other"]!!.distinct().sortedBy { it.name }
    }
