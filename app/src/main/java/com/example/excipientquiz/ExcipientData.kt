...
val excipients = listOf(
    ...
    Excipient("Gelatin", R.drawable.gelatin, "Binder, Capsule manufacture", "Polymer",
        "Hydrolyzed/denatured collagen", "Solid dosage forms", "Depends on type (can be negative or positive)", "none", "none"),
    ...
    Excipient("Hydroxypropyl cellulose", R.drawable.hydroxypropylcellulose, "Pore former, Binder, Thickener", "Polymer",
        "Hyprolose/Klucel", "Solid dosage forms, Lotions/shampoos", "Neutral", "none", "none"),
    Excipient("Hydroxypropyl methylcellulose", R.drawable.hydroxypropylmethylcellulose, "Pore former, Thickener", "Polymer",
        "Hypromellose", "Solid dosage forms, Emulsions, Suspensions", "Neutral", "none", "none"),
    ...
    Excipient("Microcrystalline Cellulose", R.drawable.cellulose, "Binder, Disintegrant", "Polymer",
        "Avicel", "Solid dosage forms", "Neutral", "none", "none"),
    ...
    Excipient("Polysorbate 80", R.drawable.polysorbate80, "Emulsifier (O/W), Solubilizer",
        "Polymer", "Tween 80, Polyoxyethylene sorbitan monooleate polyethylene glycol sorbitan monooleate", "Emulsions, Creams/ointments, Lotions/shampoos", "Neutral", "none", "none"),
    ...
    Excipient("Sodium dodecyl sulfate", R.drawable.sodiumdodecylsulfate, "Emulsifier (O/W), Lubricant, Solubilizer, Wetting agent", "Small organic molecule",
        "Sodium lauryl sulfate, SLS, SDS", "Solid dosage forms, Emulsions, Suspensions, Creams/ointments, Lotions/shampoos", "Neutral in acidic environment, negative in neutral-basic environment (pKa ≈ 3.3)", "none", "none"),
    ...
    Excipient("Sorbitan monooleate", R.drawable.span80, "Emulsifier (W/O), Wetting agent",
        "Small organic molecule", "Span 80", "Emulsions, Creams/ointments, Suspensions", "Neutral", "none", "none"),
    ...
    Excipient("Stearic acid", R.drawable.stearicacid, "Lubricant, Glidant, Emulsifier (W/O), Solubilizer", "Small organic molecule",
        "none", "Emulsions, Creams/ointments, Lotions/shampoos, Solid dosage forms", "Neutral in acidic environment, negative in neutral-basic environment (pKa ≈ 5)", "none", "none"),
