...
val excipients = listOf(
    Excipient("Adeps solidus", R.drawable.adepssolidus, "Base for suppositories", "Small organic molecule", "",
    ...
    Excipient("Agar-agar", R.drawable.agaragar, "Thickener", "Polymer",
    ...
    Excipient("Aluminium chloride", R.drawable.aluminiumchloride, "Peptizing agent", "Inorganic molecule",
    ...
    Excipient("Arabic gum", R.drawable.arabicgum, "Thickener, Emulsifier (O/W)", "Polymer",
    ...
    Excipient("Bentonite", R.drawable.bentonite, "Thickener", "Anorganic molecule", "Veegum, magnesium aluminium silicate",
    ...
    Excipient("Boric acid", R.drawable.boricacid, "Tonicity regulator, Buffer", "Anorganic molecule",
    ...
    Excipient("Cetomacrogol emulsifying wax", R.drawable.cetomacrogolemulsifyingwax, "Emulsifier (Complex O/W)", "Small organic molecule",
    ...
    Excipient("Cetrimide emulsifying wax", R.drawable.cetrimideemulsifyingwax, "Emulsifier (Complex O/W)", "Small organic molecule",
    ...
    Excipient("Colloidal silicium dioxide", R.drawable.sio2, "Lubricant, Glidant, Thickener", "Anorganic molecule",
    ...
    Excipient("Cremophor EL", R.drawable.cremophor, "Solubilizer, Emulsifier (O/W)", "Small organic molecule", "Kolliphor EL, polyethoxylated castor oil",
    ...
    Excipient("Disodium hydrogen phosphate", R.drawable.disodiumhydrogenphosphate, "Peptizing agent, Buffers", "Inorganic molecule",
        "", "Suspensions", "Neutral under very acid conditions (pKas of 2.15, 7.21, and 12.32)", "Water soluble", "Peptizing agents help with making a partially flocculated suspension by diminishing the zeta potential of the suspended particles. Deflocculated suspensions are much more stable. Particles with multiple charges are better at achieving this, which explains the common peptizing agents. Concentration: 0.001-0.1M."),
    Excipient("Ethanol", R.drawable.ethanol, "Solvent, Preservative, Cosolvent", "Small organic molecule", "Alcohol",
    ...
    Excipient("Glucose", R.drawable.glucose, "Sweetener, Tonicity regulator", "Small organic molecule",
    ...
    Excipient("Glycerol", R.drawable.glycerol, "Plasticizer, Solvent, Thickener, Sweetener, Preservative, Dispersing agent, Solvent", "Small organic molecule",
    ...
    Excipient("Hydroxyethyl cellulose", R.drawable.hydroxyethylcellulose, "Thickener", "Polymer",
    ...
    Excipient("Lanette N", R.drawable.lanette_n, "Emulsifier (Complex O/W)", "Small organic molecule",
    ...
    Excipient("Lanette SX", R.drawable.lanette_sx, "Emulsifier (Complex O/W)","Small organic molecule",
    ...
    Excipient("Lanolin", R.drawable.lanolin, "Base for creams, Emulsifier (W/O)", "Small organic molecule", "Wool fat, Sheep fat, Adeps lanae, Wool grease",
    ...
    Excipient("Methyl cellulose", R.drawable.methylcellulose, "Thickener", "Polymer",
    ...
    Excipient("Methylene blue", R.drawable.methyleneblue, "Verify emulsion type", "Small organic molecule",
    ...
    Excipient("Paraffin", R.drawable.paraffin, "Base for creams", "Small organic molecule", "Vaseline, Petroleum jelly, paraffin wax, mineral oil, paraffin oil, petroleum wax",
    ...
    Excipient("Crosslinked poly acrylic acid", R.drawable.polyacrylicacid, "Thickener", "Polymer",
    ...
    Excipient("Pectin", R.drawable.pectin, "Thickener", "Polymer",
    ...
    Excipient("Peanut oil", R.drawable.peanutoil, "Lipophilic phase in emulsions", "Small organic molecule",
    ...
    Excipient("Propylene glycol", R.drawable.propyleneglycol, "Solvent, Dispersing agent, Preservative", "Small organic molecule",
    ...
    Excipient("Polyvinyl alcohol", R.drawable.polyvinylalcohol, "Non-functional tablet coating, Binder", "Polymer",
        "none", "Solid dosage forms", "Neutral", "none", "none"),
    Excipient("Polyvinylpyrrolidone", R.drawable.pvp, "Binder, Film former", "Polymer",
    ...
    Excipient("Polyvinylpyrrolidone-co-vinyl acetate", R.drawable.pvpva, "Binder, Film former", "Polymer",
        "none", "Solid dosage forms", "Neutral", "none", "none"),
    Excipient("Potassium citrate", R.drawable.potassiumcitrate, "Peptising agent", "Small organic molecule",
    ...
    Excipient("Potassium nitrate", R.drawable.potassiumnitrate, "Tonicity regulator", "Anorganic molecule",
    ...
    Excipient("Potassium tartrate", R.drawable.potassiumtartrate, "Peptising agent", "Small organic molecule",
    ...
    Excipient("Sodium alginate", R.drawable.sodiumalginate, "Thickener, Emulsifier (O/W)", "Polymer",
    ...
    Excipient("Sodium alkyl sulfate", R.drawable.sodiumalkylsulfate, "Emulsifier (Complex O/W)", "Small organic molecule",
    ...
    Excipient("Sodium chloride", R.drawable.nacl, "Thickener, Tonicity regulator", "Inorganic molecule", "Table salt",
    ...
    Excipient("(cross-linked) Sodium carboxymethyl cellulose", R.drawable.sodiumcarboxymethylcellulose, "Thickener, disintegrant", "Polymer",
    ...
    Excipient("Sodium citrate", R.drawable.sodiumcitrate, "Peptising agent", "Small organic molecule",
        "", "Suspensions", "Neutral under very acidic conditions (pKas of 3, 4.76, and 6.4), negative otherwise.", "Water soluble", "Peptizing agents help with making a partially flocculated suspension by diminishing the zeta potential of the suspended particles. Deflocculated suspensions are much more stable. Particles with multiple charges are better at achieving this, which explains the common peptizing agents. Concentration: 0.001-0.1M."),
    ...
    Excipient("Sodium pyrophosphate", R.drawable.sodiumpyrophosphate, "Peptizing agent", "Inorganic molecule",
    ...
    Excipient("Sudan III red", R.drawable.sudaniii, "Verify emulsion type", "Small organic molecule",
    ...
    Excipient("Tragacanth", R.drawable.tragacanth, "Thickener, Emulsifier (O/W)", "Polymer",
    ...
    Excipient("Xantham gum", R.drawable.xanthangum, "Thickener", "Polymer",
...
private fun createGroupedQuizModes(excipients: List<Excipient>, allItemsName: String): Map<String, List<Excipient>> {
    ...
    keyMap.toSortedMap(String.CASE_INSENSITIVE_ORDER).forEach { (groupName, excipientList) ->
        if (excipientList.size > 1) {
